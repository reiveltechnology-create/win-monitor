...
// Usado pelo Coolify pra saber que o container está vivo.
// Precisa responder 200 SEM exigir login.
app.get('/health', (req, res) => {
  res.status(200).json({ status: 'ok', service: 'win-monitor', time: new Date().toISOString() });
});
